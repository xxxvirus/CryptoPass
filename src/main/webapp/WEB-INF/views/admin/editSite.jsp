...
<div class="row">
	...
	<div class="col-md-7 col-sm-12 col-xs-12">
		<form:form class="form-horizontal" action="/user/${user.id}/editSite/${site.id}"
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<form:input class="form-control" path="loginOnS" id="loginOnS"/>
				</div>
			</div>
			<div class="form-group">
				<label for="login" class="col-sm-2 control-label">Password</label>
				<div class="col-sm-7">
					<form:input class="form-control" path="pass" id="pass" />
				</div>
			</div>
			<div class="form-group">
